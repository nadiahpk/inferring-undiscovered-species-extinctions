...
fname = '../../../results/classical/sensitivity/sensitivity_species_deletion/sensitivity_spp_deletion_UT0_all.pkl'
...
# plt.show()
plt.tight_layout()
plt.savefig('../../../results/classical/sensitivity/sensitivity_species_deletion/sensitivity_species_deletion_UT0.pdf')
plt.close()

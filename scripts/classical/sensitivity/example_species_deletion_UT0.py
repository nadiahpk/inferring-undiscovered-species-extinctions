...
propn = 0.3 # use only 0.3 of our record
...
# need to know how many extant in full record to calculate subset size
...
subset_size = int(round(no_spp_full*propn))
...
f = open(dir_results + 'example_species_deletion_UT0.csv', 'w')
